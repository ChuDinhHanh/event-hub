    ...
    return (
        ...
        styles.wrapper_input]}>
            <TextInput
                ...
                onChangeText={val => onChange(id, val.length === 0 ? val : val[val.length - 1])}
            ...
            />
            {
                showLine && !Boolean(code) && <View style={{ position: 'absolute', width: 13.5, height: 2, backgroundColor: appColors.gray4 }} />
            }
        </View>
    )
}
